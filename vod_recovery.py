...
def get_latest_streams_from_twitchtracker(skip_gql=False):
    ...
    if not skip_gql:
        ...
        if not streams:
            streams = fetch_vod_vod_streams(streamer_name)
    ...
    while True:
        ...
        if choice == "1":
            ...
            get_latest_streams_from_twitchtracker(skip_gql=True)
        else:
            print("\nInvalid option. Please try again.")
